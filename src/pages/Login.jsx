...
function Login() {
  ...
  useEffect(() => {
    ...
    loadScript("https://cdn.jsdelivr.net/npm/vanta@latest/dist/vanta.clouds.min.js").then(() => {
      if (window.VANTA) {
  ...
  return (
    <div ref={vantaRef} className="w-screen h-screen relative overflow-hidden">
      {/* Centered login form over background */}
      <div className="absolute inset-0 flex items-center justify-center z-10">
        <div className="form-container bg-white/80 backdrop-blur-lg shadow-xl p-8 rounded-md">
